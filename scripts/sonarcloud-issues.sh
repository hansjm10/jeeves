...
Usage:
  ./scripts/sonarcloud-issues.sh [--branch <name> | --pull-request <id>] [--out <file>] [--host <url>]
...
Examples:
  ./scripts/sonarcloud-issues.sh --branch issue/590-rng-prd --out jeeves/sonar-issues.json
  ./scripts/sonarcloud-issues.sh --pull-request 1234
EOF
}
