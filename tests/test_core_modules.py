...
def load_module_from_path(module_name: str, file_path: Path, saved_modules: dict[str, object | None]):
...
def restore_modules(saved_modules: dict[str, object | None]) -> None:
...
class TestCoreModulesImportable:
    ...
    def test_paths_importable(self):
        ...
        try:
            paths = load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
    ...
    def test_repo_importable(self):
        ...
        try:
            ...
            load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
            repo = load_module_from_path("jeeves.core.repo", core_dir / "repo.py", saved_modules)
    ...
    def test_config_importable(self):
        ...
        try:
            ...
            load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
            config = load_module_from_path("jeeves.core.config", core_dir / "config.py", saved_modules)
    ...
    def test_issue_importable(self):
        ...
        try:
            ...
            load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
            load_module_from_path("jeeves.core.repo", core_dir / "repo.py", saved_modules)
            issue = load_module_from_path("jeeves.core.issue", core_dir / "issue.py", saved_modules)

            assert hasattr(issue, 'IssueError'), "issue should have IssueError"
            assert hasattr(issue, 'IssueState'), "issue should have IssueState"
            assert hasattr(issue, 'GitHubIssue'), "issue should have GitHubIssue"
        finally:
            restore_modules(saved_modules)
    ...
    def test_browse_importable(self):
        ...
        try:
            ...
            load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
            load_module_from_path("jeeves.core.repo", core_dir / "repo.py", saved_modules)
            load_module_from_path("jeeves.core.issue", core_dir / "issue.py", saved_modules)
            browse = load_module_from_path("jeeves.core.browse", core_dir / "browse.py", saved_modules)
    ...
    def test_worktree_importable(self):
        ...
        try:
            ...
            load_module_from_path("jeeves.core.paths", core_dir / "paths.py", saved_modules)
            load_module_from_path("jeeves.core.repo", core_dir / "repo.py", saved_modules)
            worktree = load_module_from_path("jeeves.core.worktree", core_dir / "worktree.py", saved_modules)
